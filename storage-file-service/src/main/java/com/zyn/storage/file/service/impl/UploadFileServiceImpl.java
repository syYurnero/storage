...
import com.zyn.storage.file.remote.CoreRemote;
import com.zyn.storage.file.service.IUploadFileService;
import com.zyn.storage.file.utils.FileUtils;
import com.zyn.storage.framework.redis.core.utils.RedisUtil;
import com.zyn.storage.request.*;
import com.zyn.storage.request.base.RestAPIResultDTO;
import com.zyn.storage.utils.IDUtils;
...
public class UploadFileServiceImpl implements IUploadFileService {
    ...
    private FileDO saveFileToDatabase(MultipartFile file, String path, String md5) {
        ...
        } else if (contentType.equals("video/mp4") || contentType.equals("video/mpeg4") || contentType.equals("video/avi") || contentType.equals("application/vnd.rn-realmedia-vbr") || contentType.equals("video/mpg") || contentType.equals("video/x-ms-wmv")) {
